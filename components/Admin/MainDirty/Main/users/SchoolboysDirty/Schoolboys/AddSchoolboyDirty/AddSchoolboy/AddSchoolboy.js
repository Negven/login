...
import Classes from './AddSchoolboy.module.css'
...
export default function AddSchoolboy(props) {
        ...
        <div>
            ...
            <div className={Classes.popUpEdit}>
                <div className={Classes.blockTeach1}>
                    ...
                    <div>
                        <TextField
                            ...
                            value={props.schoolboy.name.secondName}
                    ...
                    <div>
                        <TextField
                            id="outlined-name"
                            className={classes.textField}
                            value={props.schoolboy.name.firstName}
                    ...
                    <div>
                        <TextField
                            id="outlined-name"
                            className={classes.textField}
                            value={props.schoolboy.name.lastName}
                    ...
                    <div>
                        <TextField
                            id="outlined-name"
                            className={classes.textField}
                            value={props.schoolboy.password}
                ...
                <div className={Classes.blockTeach1}>
                    ...
                    <Select
                        native
                        value={props.schoolboy.profession}
                        className={classes.textField}
                    ...
                    <div className={Classes.teachLineBtn}>
                        <div className={Classes.saveBtnTech} onClick={() => {props.addSchoolboy(props.schoolboy); props.closeAdd()}}><div className={Classes.textBtn}>Зберегти</div></div>
