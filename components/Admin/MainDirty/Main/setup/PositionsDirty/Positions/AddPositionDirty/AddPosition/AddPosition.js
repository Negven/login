...
import Classes from './AddPosition.module.css'
            ...
            <div className={Classes.popUpEdit}>
                <div className={Classes.blockTeach1}>
                    ...
                    <div className={Classes.teachLineBtn}>
                        <div className={Classes.saveBtnTech} onClick={() => {props.addPosition(props.position); props.closeAdd()}}><div className={Classes.textBtn}>Зберегти</div></div>
